...
export function createFranchiseState(params?: {
  ...
  const otherTeams = [
    createTeam('t1', 'Aurora Raptors', 'AI GM Kim', 'AR', '#22c55e'),
    createTeam('t2', 'Neon Kings', 'AI GM Patel', 'NK', '#a855f7'),
    createTeam('t3', 'Harbor Hawks', 'AI GM Chen', 'HH', '#06b6d4'),
    createTeam('t4', 'Cinder Cyclones', 'AI GM Rivera', 'CC', '#f59e0b'),
    createTeam('t5', 'Atlas Aces', 'AI GM Novak', 'AA', '#3b82f6'),
    createTeam('t6', 'Metro Meteors', 'AI GM Ito', 'MM', '#10b981'),
    createTeam('t7', 'Solar Serpents', 'AI GM Lopez', 'SS', '#f97316'),
    createTeam('t8', 'Glacier Giants', 'AI GM Brooks', 'GG', '#38bdf8'),
    createTeam('t9', 'Voltage Vipers', 'AI GM Singh', 'VV', '#84cc16'),
    createTeam('t10', 'Summit Storm', 'AI GM Alvarez', 'ST', '#e11d48'),
    createTeam('t11', 'Zenith Zephyrs', 'AI GM Morgan', 'ZZ', '#8b5cf6'),
    createTeam('t12', 'Prairie Pioneers', 'AI GM Rossi', 'PP', '#14b8a6'),
    createTeam('t13', 'Horizon Hornets', 'AI GM Zhou', 'HH', '#f472b6'),
    createTeam('t14', 'Iron Icemen', 'AI GM Carter', 'II', '#0ea5e9'),
    createTeam('t15', 'Frost Falcons', 'AI GM Baker', 'FF', '#60a5fa'),
    createTeam('t16', 'Ember Eagles', 'AI GM Park', 'EE', '#f97316'),
    createTeam('t17', 'Quantum Quakes', 'AI GM Ahmed', 'QQ', '#a855f7'),
    createTeam('t18', 'Lunar Lynx', 'AI GM Silva', 'LL', '#818cf8'),
    createTeam('t19', 'Titan Tides', 'AI GM Grant', 'TT', '#22c55e'),
    createTeam('t20', 'Vortex Vultures', 'AI GM Evans', 'VV', '#14b8a6'),
    createTeam('t21', 'Eclipse Eagles', 'AI GM Davis', 'EE', '#fb7185'),
    createTeam('t22', 'Cobalt Comets', 'AI GM Singh', 'CC', '#0ea5e9'),
    createTeam('t23', 'Neptune Ninjas', 'AI GM Owens', 'NN', '#38bdf8'),
    createTeam('t24', 'Phoenix Phantoms', 'AI GM Zhang', 'PP', '#facc15'),
    createTeam('t25', 'Sapphire Sharks', 'AI GM Turner', 'SS', '#22d3ee'),
    createTeam('t26', 'Crimson Crusaders', 'AI GM King', 'CC', '#dc2626'),
    createTeam('t27', 'Aurora Aces', 'AI GM Walls', 'AA', '#7c3aed'),
    createTeam('t28', 'Nebula Knights', 'AI GM Ortiz', 'NK', '#0f766e'),
  ];
