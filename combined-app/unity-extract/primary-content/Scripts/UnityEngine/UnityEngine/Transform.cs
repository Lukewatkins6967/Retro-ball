...
namespace UnityEngine
{
	public class Transform : Component, IEnumerable
	{
		...
		{
			Vector3 value;
			INTERNAL_CALL_GetLocalEulerAngles(this, order, out value);
			return value;
		}
		...
		{
			Vector3 value;
			INTERNAL_CALL_TransformDirection(this, ref direction, out value);
			return value;
		}
		...
		{
			Vector3 value;
			INTERNAL_CALL_InverseTransformDirection(this, ref direction, out value);
			return value;
		}
		...
		{
			Vector3 value;
			INTERNAL_CALL_TransformVector(this, ref vector, out value);
			return value;
		}
		...
		{
			Vector3 value;
			INTERNAL_CALL_InverseTransformVector(this, ref vector, out value);
			return value;
		}
		...
		{
			Vector3 value;
			INTERNAL_CALL_TransformPoint(this, ref position, out value);
			return value;
		}
		...
		{
			Vector3 value;
			INTERNAL_CALL_InverseTransformPoint(this, ref position, out value);
			return value;
		}
