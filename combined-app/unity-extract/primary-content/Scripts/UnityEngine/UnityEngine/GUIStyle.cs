...
namespace UnityEngine
{
	...
	public sealed class GUIStyle
	{
		...
		{
			Vector2 ret;
			Internal_CalcSizeWithConstraints(m_Ptr, content, constraints, out ret);
			return ret;
		}
		...
		{
			IntPtr value;
			INTERNAL_CALL_GetStyleStatePtr(this, idx, out value);
			return value;
		}
		...
		{
			IntPtr value;
			INTERNAL_CALL_GetRectOffsetPtr(this, idx, out value);
			return value;
		}
