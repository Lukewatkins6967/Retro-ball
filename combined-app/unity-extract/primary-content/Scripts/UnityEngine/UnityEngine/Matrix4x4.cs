...
namespace UnityEngine
{
	...
	public struct Matrix4x4
	{
		...
		{
			Matrix4x4 value;
			INTERNAL_CALL_Inverse(ref m, out value);
			return value;
		}
		...
		{
			Matrix4x4 value;
			INTERNAL_CALL_Transpose(ref m, out value);
			return value;
		}
		...
		{
			Matrix4x4 value;
			INTERNAL_CALL_TRS(ref pos, ref q, ref s, out value);
			return value;
		}
		...
		{
			Matrix4x4 value;
			INTERNAL_CALL_Ortho(left, right, bottom, top, zNear, zFar, out value);
			return value;
		}
		...
		{
			Matrix4x4 value;
			INTERNAL_CALL_Perspective(fov, aspect, zNear, zFar, out value);
			return value;
		}
