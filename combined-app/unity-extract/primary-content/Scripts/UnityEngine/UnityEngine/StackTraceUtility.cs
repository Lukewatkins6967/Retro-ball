	...
	public class StackTraceUtility
	{
		...
		internal static string ExtractFormattedStackTrace(StackTrace stackTrace)
		{
			...
			for (int i = 0; i < stackTrace.FrameCount; i++)
			{
				...
				if (text2 != null && (!(declaringType.Name == "Debug") || !(declaringType.Namespace == "UnityEngine")) && (!(declaringType.Name == "Logger") || !(declaringType.Namespace == "UnityEngine")) && (!(declaringType.Name == "DebugLogHandler") || !(declaringType.Namespace == "UnityEngine")) && (!(declaringType.Name == "Assert") || !(declaringType.Namespace == "UnityEngine.Assertions")))
				{
