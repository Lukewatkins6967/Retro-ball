...
namespace UnityEngine
{
	...
	public sealed class Animator : DirectorPlayer
	{
		...
		public Vector3 deltaPosition
		{
			...
			{
				Vector3 value;
				INTERNAL_get_deltaPosition(out value);
				return value;
			}
		}
		...
		public Quaternion deltaRotation
		{
			...
			{
				Quaternion value;
				INTERNAL_get_deltaRotation(out value);
				return value;
			}
		}
		...
		public Vector3 pivotPosition
		{
			...
			{
				Vector3 value;
				INTERNAL_get_pivotPosition(out value);
				return value;
			}
		}
		...
		{
			Vector3 value;
			INTERNAL_CALL_GetBodyPositionInternal(this, out value);
			return value;
		}
		...
		{
			Quaternion value;
			INTERNAL_CALL_GetBodyRotationInternal(this, out value);
			return value;
		}
		...
		{
			Vector3 value;
			INTERNAL_CALL_GetIKPositionInternal(this, goal, out value);
			return value;
		}
		...
		{
			Quaternion value;
			INTERNAL_CALL_GetIKRotationInternal(this, goal, out value);
			return value;
		}
		...
		{
			Vector3 value;
			INTERNAL_CALL_GetIKHintPositionInternal(this, hint, out value);
			return value;
		}
