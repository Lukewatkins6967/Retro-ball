...
namespace UnityEngine
{
	public sealed class Rigidbody : Component
	{
		...
		{
			Vector3 value;
			INTERNAL_CALL_ClosestPointOnBounds(this, ref position, out value);
			return value;
		}
		...
		{
			Vector3 value;
			INTERNAL_CALL_GetRelativePointVelocity(this, ref relativePoint, out value);
			return value;
		}
		...
		{
			Vector3 value;
			INTERNAL_CALL_GetPointVelocity(this, ref worldPoint, out value);
			return value;
		}
