...
namespace UnityEngine.Experimental.Director
{
	...
	public struct Playable
	{
		...
		{
			return (T)Playables.CastToInternal(typeof(T), m_Handle, m_Version);
		}
		...
		{
			Playable value;
			INTERNAL_CALL_GetInputInternal(ref playable, index, out value);
			return value;
		}
		...
		{
			Playable value;
			INTERNAL_CALL_GetOutputInternal(ref playable, index, out value);
			return value;
		}
		...
		{
			return p != null && p.GetHashCode() == GetHashCode();
		}

		public override int GetHashCode()
		{
			return (int)m_Handle ^ m_Version;
		}
