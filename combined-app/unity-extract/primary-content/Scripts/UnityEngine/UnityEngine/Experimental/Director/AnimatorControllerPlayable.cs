...
namespace UnityEngine.Experimental.Director
{
	...
	public struct AnimatorControllerPlayable
	{
		...
		{
			AnimatorControllerPlayable that = default(AnimatorControllerPlayable);
		...
		{
			float normalizedTime = float.NegativeInfinity;
			CrossFadeInternal(ref that, stateNameHash, transitionDuration, layer, normalizedTime);
		}
		...
		{
			float fixedTime = float.NegativeInfinity;
			PlayInFixedTimeInternal(ref that, stateNameHash, layer, fixedTime);
		}
		...
		{
			PlayInternal(ref this, StringToHash(stateName), layer, normalizedTime);
		}
		...
		{
			PlayInternal(ref this, stateNameHash, layer, normalizedTime);
		}
		...
		{
			float normalizedTime = float.NegativeInfinity;
			PlayInternal(ref that, stateNameHash, layer, normalizedTime);
		}
		...
		{
			return HasStateInternal(ref this, layerIndex, stateID);
		}
