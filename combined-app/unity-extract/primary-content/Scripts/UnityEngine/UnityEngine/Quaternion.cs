...
namespace UnityEngine
{
	...
	public struct Quaternion
	{
		...
		{
			Vector3 value;
			INTERNAL_CALL_Internal_ToEulerRad(ref rotation, out value);
			return value;
		}
		...
		{
			Quaternion value;
			INTERNAL_CALL_Internal_FromEulerRad(ref euler, out value);
			return value;
		}
		...
		{
			Quaternion value;
			INTERNAL_CALL_AxisAngle(ref axis, angle, out value);
			return value;
		}
