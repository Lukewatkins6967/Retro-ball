namespace InControl
{
	public class XboxOneInputDevice : InputDevice
	{
		...
		private void AnalogAxisNameForId(uint analogId)
		{
		...
		private void CacheAnalogAxisNames()
		{
			...
			AnalogAxisNameForId(0u);
			AnalogAxisNameForId(1u);
			AnalogAxisNameForId(3u);
			AnalogAxisNameForId(4u);
			AnalogAxisNameForId(8u);
			AnalogAxisNameForId(9u);
		}
	}
}
