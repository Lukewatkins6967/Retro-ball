...
namespace InControl
{
	public class PlayerAction : OneAxisInputControl
	{
		...
		private bool LastInputTypeIsDevice
		{
			get
			{
				return LastInputType == BindingSourceType.DeviceBindingSource || LastInputType == BindingSourceType.UnknownDeviceBindingSource;
			}
		}
		...
		private void UpdateBindings(ulong updateTick, float deltaTime)
		{
			...
			{
				bool flag = bindingSourceType != LastInputType;
