...
namespace UnityEngine.UI
{
	...
	public class Slider : Selectable, IEventSystemHandler, IInitializePotentialDragHandler, IDragHandler, ICanvasElement
	{
		...
		private void UpdateDrag(PointerEventData eventData, Camera cam)
		{
			...
			Vector2 localPoint;
			if (rectTransform != null && rectTransform.rect.size[(int)axis] > 0f && RectTransformUtility.ScreenPointToLocalPointInRectangle(rectTransform, eventData.position, cam, out localPoint))
			{
