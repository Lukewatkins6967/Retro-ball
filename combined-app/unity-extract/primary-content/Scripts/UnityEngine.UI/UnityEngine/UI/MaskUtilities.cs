...
namespace UnityEngine.UI
{
	public class MaskUtilities
	{
		...
		public static RectMask2D GetRectMaskForClippable(IClippable clippable)
		{
			...
			clippable.rectTransform.GetComponentsInParent(false, list);
			if (list.Count > 0)
			{
				for (int i = 0; i < list.Count; i++)
				{
					...
					clippable.rectTransform.GetComponentsInParent(false, list2);
		...
		public static void GetRectMasksForClip(RectMask2D clipper, List<RectMask2D> masks)
		{
			...
			clipper.transform.GetComponentsInParent(false, list2);
			if (list2.Count > 0)
			{
				clipper.transform.GetComponentsInParent(false, list);
				for (int num = list2.Count - 1; num >= 0; num--)
				{
