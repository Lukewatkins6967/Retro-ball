...
namespace UnityEngine.UI
{
	...
	public class Text : MaskableGraphic, ILayoutElement
	{
		...
		public TextGenerator cachedTextGenerator
		{
			get
			{
				return m_TextCache ?? (m_TextCache = ((m_Text.Length == 0) ? new TextGenerator() : new TextGenerator(m_Text.Length)));
			}
		}
		...
		public TextGenerator cachedTextGeneratorForLayout
		{
			get
			{
				return m_TextCacheForLayout ?? (m_TextCacheForLayout = new TextGenerator());
			}
		}
