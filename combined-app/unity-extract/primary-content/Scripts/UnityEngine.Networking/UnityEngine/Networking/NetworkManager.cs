...
namespace UnityEngine.Networking
{
	...
	public class NetworkManager : MonoBehaviour
	{
		...
		private bool StartServer(MatchInfo info, ConnectionConfig config, int maxConnections)
		{
			...
			if (m_OnlineScene != string.Empty && m_OnlineScene != text && m_OnlineScene != m_OfflineScene)
			{
		...
		public void SetMatchHost(string newHost, int port, bool https)
		{
			...
			{
				newHost = newHost.Replace("http://", string.Empty);
			}
			if (newHost.StartsWith("https://"))
			{
				newHost = newHost.Replace("https://", string.Empty);
			}
			m_MatchHost = newHost;
			m_MatchPort = port;
