...
namespace UnityEngine.Networking
{
	...
	public class NetworkLobbyManager : NetworkManager
	{
		...
		private void OnServerReadyToBeginMessage(NetworkMessage netMsg)
		{
			...
			PlayerController playerController;
			if (!netMsg.conn.GetPlayerController(s_ReadyToBeginMessage.slotId, out playerController))
			{
		...
		private void OnServerSceneLoadedMessage(NetworkMessage netMsg)
		{
			...
			PlayerController playerController;
			if (!netMsg.conn.GetPlayerController((short)s_SceneLoadedMessage.value, out playerController))
			{
				if (LogFilter.logError)
				{
