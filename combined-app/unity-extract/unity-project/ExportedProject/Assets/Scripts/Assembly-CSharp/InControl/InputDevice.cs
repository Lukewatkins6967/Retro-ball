...
namespace InControl
{
	public class InputDevice
	{
		...
		public InputControl LeftStickUp
		{
			get
			{
				return cachedLeftStickUp ?? (cachedLeftStickUp = GetControl(InputControlType.LeftStickUp));
			}
		}
		...
		public InputControl LeftStickDown
		{
			get
			{
				return cachedLeftStickDown ?? (cachedLeftStickDown = GetControl(InputControlType.LeftStickDown));
			}
		}
		...
		public InputControl LeftStickLeft
		{
			get
			{
				return cachedLeftStickLeft ?? (cachedLeftStickLeft = GetControl(InputControlType.LeftStickLeft));
			}
		}
		...
		public InputControl LeftStickRight
		{
			get
			{
				return cachedLeftStickRight ?? (cachedLeftStickRight = GetControl(InputControlType.LeftStickRight));
			}
		}
		...
		public InputControl RightStickUp
		{
			get
			{
				return cachedRightStickUp ?? (cachedRightStickUp = GetControl(InputControlType.RightStickUp));
			}
		}
		...
		public InputControl RightStickDown
		{
			get
			{
				return cachedRightStickDown ?? (cachedRightStickDown = GetControl(InputControlType.RightStickDown));
			}
		}
		...
		public InputControl RightStickLeft
		{
			get
			{
				return cachedRightStickLeft ?? (cachedRightStickLeft = GetControl(InputControlType.RightStickLeft));
			}
		}
		...
		public InputControl RightStickRight
		{
			get
			{
				return cachedRightStickRight ?? (cachedRightStickRight = GetControl(InputControlType.RightStickRight));
			}
		}
		...
		public InputControl DPadUp
		{
			get
			{
				return cachedDPadUp ?? (cachedDPadUp = GetControl(InputControlType.DPadUp));
			}
		}
		...
		public InputControl DPadDown
		{
			get
			{
				return cachedDPadDown ?? (cachedDPadDown = GetControl(InputControlType.DPadDown));
			}
		}
		...
		public InputControl DPadLeft
		{
			get
			{
				return cachedDPadLeft ?? (cachedDPadLeft = GetControl(InputControlType.DPadLeft));
			}
		}
		...
		public InputControl DPadRight
		{
			get
			{
				return cachedDPadRight ?? (cachedDPadRight = GetControl(InputControlType.DPadRight));
			}
		}
		...
		public InputControl Action1
		{
			get
			{
				return cachedAction1 ?? (cachedAction1 = GetControl(InputControlType.Action1));
			}
		}
		...
		public InputControl Action2
		{
			get
			{
				return cachedAction2 ?? (cachedAction2 = GetControl(InputControlType.Action2));
			}
		}
		...
		public InputControl Action3
		{
			get
			{
				return cachedAction3 ?? (cachedAction3 = GetControl(InputControlType.Action3));
			}
		}
		...
		public InputControl Action4
		{
			get
			{
				return cachedAction4 ?? (cachedAction4 = GetControl(InputControlType.Action4));
			}
		}
		...
		public InputControl LeftTrigger
		{
			get
			{
				return cachedLeftTrigger ?? (cachedLeftTrigger = GetControl(InputControlType.LeftTrigger));
			}
		}
		...
		public InputControl RightTrigger
		{
			get
			{
				return cachedRightTrigger ?? (cachedRightTrigger = GetControl(InputControlType.RightTrigger));
			}
		}
		...
		public InputControl LeftBumper
		{
			get
			{
				return cachedLeftBumper ?? (cachedLeftBumper = GetControl(InputControlType.LeftBumper));
			}
		}
		...
		public InputControl RightBumper
		{
			get
			{
				return cachedRightBumper ?? (cachedRightBumper = GetControl(InputControlType.RightBumper));
			}
		}
		...
		public InputControl LeftStickButton
		{
			get
			{
				return cachedLeftStickButton ?? (cachedLeftStickButton = GetControl(InputControlType.LeftStickButton));
			}
		}
		...
		public InputControl RightStickButton
		{
			get
			{
				return cachedRightStickButton ?? (cachedRightStickButton = GetControl(InputControlType.RightStickButton));
			}
		}
		...
		public InputControl LeftStickX
		{
			get
			{
				return cachedLeftStickX ?? (cachedLeftStickX = GetControl(InputControlType.LeftStickX));
			}
		}
		...
		public InputControl LeftStickY
		{
			get
			{
				return cachedLeftStickY ?? (cachedLeftStickY = GetControl(InputControlType.LeftStickY));
			}
		}
		...
		public InputControl RightStickX
		{
			get
			{
				return cachedRightStickX ?? (cachedRightStickX = GetControl(InputControlType.RightStickX));
			}
		}
		...
		public InputControl RightStickY
		{
			get
			{
				return cachedRightStickY ?? (cachedRightStickY = GetControl(InputControlType.RightStickY));
			}
		}
		...
		public InputControl DPadX
		{
			get
			{
				return cachedDPadX ?? (cachedDPadX = GetControl(InputControlType.DPadX));
			}
		}
		...
		public InputControl DPadY
		{
			get
			{
				return cachedDPadY ?? (cachedDPadY = GetControl(InputControlType.DPadY));
			}
		}
		...
		public InputControl Command
		{
			get
			{
				return cachedCommand ?? (cachedCommand = GetControl(InputControlType.Command));
			}
		}
