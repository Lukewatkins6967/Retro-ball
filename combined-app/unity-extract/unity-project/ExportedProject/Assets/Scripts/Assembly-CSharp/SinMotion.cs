...
public class SinMotion : MonoBehaviour
{
	...
	private void Update()
	{
		...
		{
			base.transform.position = m_originalPosition + new Vector3(m_positionMag.x * Mathf.Sin(m_positionDelta.x * m_timer), m_positionMag.y * Mathf.Sin(m_positionDelta.y * m_timer), 0f);
		}
